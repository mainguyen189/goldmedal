package com.code.goldmedal.controller;

import com.code.goldmedal.model.*;
import com.code.goldmedal.repositories.CountryRepository;
import com.code.goldmedal.repositories.GoldMedalRepository;
...
public class GoldMedalController {
    //declare references to repositories
    private final CountryRepository countryRepository;
    private final GoldMedalRepository goldMedalRepository;

    //update constructor to include repositories
    ...
    private CountryDetailsResponse getCountryDetailsResponse(String countryName) {
        var countryOptional = countryRepository.getAllByOrderByNameAsc();
